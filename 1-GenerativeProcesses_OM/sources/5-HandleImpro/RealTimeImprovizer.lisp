...
; VOIR DIFFERENCES AVEC VERSION DANS OM 7 (pareil pour improvizer.lisp)


(in-package :om)

(format *om-stream* "loading RealTimeImprovizer~%")
...
(defclass* RealtimeImprovizer (improvizer)
   (
    ...
    (modeRT :initform t :initarg :modeRT :accessor modeRT)
    ))
