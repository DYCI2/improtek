# SCRIPT A UTILISER : LANCER LA VERSION DU SYSTEME COPIEE DANS "APPLICATIONS"
# WS-AUTOLOAD.LISP ASSOCIE : DANS AutoLoadsOM/ImproteK-Applications
...
#sleep 2
#open -a /Applications/OM\ 6.9-2/OM\ 6.9-2.app
...
#sleep 2
#open -a /Applications/OM\ 6.9-3/OM\ 6.9-3.app
...
execPath='/Applications/ImproteK/2-AudioInterface_Max/'
cd "$execPath"
...
cp ./AutoLoadsOM/ImproteK-Applications/WS-autoload.lisp /Applications/OM\ 6.12/patches
sleep 4
#lancerOM
