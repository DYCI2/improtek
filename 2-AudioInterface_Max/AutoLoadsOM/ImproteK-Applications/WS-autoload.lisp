; Version pour lancer LA VERSION DU SYSTEME COPIEE DANS "APPLICATIONS"
; Script associé : Launch.sh


(in-package :om)
(setf *workspace* "/Applications/ImproteK/1-GenerativeProcesses_OM/WorkspaceImproteK/")
(setf *start-server* "/Applications/ImproteK/1-GenerativeProcesses_OM/sources/StartServerMax.lisp")
