...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 717.0, 143.0, 103.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 54.0, 222.880402, 87.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.968609, 40.879517, 57.0, 24.0 ],
					"size" : 158.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 63.0, 448.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.968609, 50.879517, 62.0, 14.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 113.0, 515.575684, 74.0, 20.0 ],
					"style" : "",
					"text" : "tapout~ 400"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.0, 487.575714, 74.0, 20.0 ],
					"style" : "",
					"text" : "tapin~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 113.0, 389.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					"comment" : "signal: Record R",
					"id" : "obj-29",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 113.0, 159.401871, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.272583, 159.401871, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 54.0, 190.880402, 37.0, 20.0 ],
					"style" : "",
					"text" : "t 127"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 54.0, 128.880402, 60.0, 20.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 264.077423, 125.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 389.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "*~ 1."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 118.0, 89.0, 19.0 ],
									"style" : "",
									"text" : "prepend format"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 409.0, 118.0, 91.0, 19.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 248.0, 26.0, 80.0, 32.0 ],
									"style" : "",
									"text" : "Sample type\ndefault int24"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 248.0, 87.0, 63.0, 19.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 390.0, 87.0, 57.0, 19.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 390.0, 26.0, 83.0, 32.0 ],
									"style" : "",
									"text" : "File type\ndefault AIFF"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 66.0, 66.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 909.0, 472.253937, 99.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 772.929565, 405.879517, 78.0, 20.0 ],
					"style" : "",
					"text" : "Buffer full ?"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.0, 11.0, 70.0, 20.0 ],
					"style" : "",
					"text" : "r #0-Stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 618.0, 448.0, 72.0, 20.0 ],
					"style" : "",
					"text" : "s #0-Stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 602.0, 423.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 909.0, 448.0, 95.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 602.0, 398.0, 32.5, 20.0 ],
					"style" : "",
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 699.0, 566.0, 153.0, 44.0 ],
					"style" : "",
					"text" : "▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 602.0, 474.0, 164.5, 20.0 ],
					"style" : "",
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 602.0, 555.0, 153.0, 44.0 ],
					"style" : "",
					"text" : "▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 651.0, 529.0, 162.0, 18.0 ],
					"style" : "",
					"text" : "!!! ---- #1_Buffer FULL ---- ¡¡¡"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 748.0, 500.0, 95.0, 20.0 ],
					"style" : "",
					"text" : "s #1_Buffer-Full"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 651.0, 627.0, 109.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 651.0, 501.0, 43.0, 20.0 ],
					"style" : "",
					"text" : "uzi 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 909.0, 425.0, 102.0, 20.0 ],
					"style" : "",
					"text" : "s #1_AudioReset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 185.0, 102.0, 20.0 ],
					"style" : "",
					"text" : "s #1_AudioReset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 66.0, 66.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 615.0, 37.0, 18.0 ],
					"style" : "",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 391.0, 354.416626, 103.0, 20.0 ],
					"style" : "",
					"text" : "translate ticks ms"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 300.0, 275.0, 186.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 591.0, 115.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 646.0, 261.0, 20.0 ],
					"style" : "",
					"text" : "record~ #1_Buffer 2 @transport #1_BufferTime"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 589.0, 275.0, 130.0, 20.0 ],
					"style" : "",
					"text" : "buffer~ #1_Buffer 10 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 515.575684, 74.0, 20.0 ],
					"style" : "",
					"text" : "tapout~ 400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "tapconnect" ],
					"patching_rect" : [ 23.0, 487.575714, 74.0, 20.0 ],
					"style" : "",
					"text" : "tapin~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 349.416626, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"comment" : "signal: Record L",
					"id" : "obj-77",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 67.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.968609, 21.353281, 16.0, 16.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.921631, 584.879517, 68.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 18.946995, 1.883435, 50.793938, 20.0 ],
					"style" : "",
					"text" : "Record"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 38.265289, 18.517052, 19.0, 20.0 ],
					"style" : "",
					"text" : ":"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 22.06451, 19.472954, 22.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 44.216583, 19.472954, 22.0, 20.0 ],
					"style" : "",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"triangle" : 0,
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 20.013241, 20.093025, 47.294239, 20.76734 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 43.0, 422.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.968609, 40.879517, 62.0, 14.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 594.921631, 390.802979, 272.272736, 269.545471 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.016113, 563.781067, 349.983887, 121.111191 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 400.5, 384.5, 611.5, 384.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 400.5, 384.0, 525.5, 384.0, 525.5, 201.0, 599.5, 201.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 863.5, 230.0, 802.0, 230.0, 802.0, 383.0, 625.0, 383.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 643.0, 171.0, 513.0, 171.0, 513.0, 631.0, 193.833333, 631.0 ],
					"source" : [ "obj-57", 3 ]
				}
